  ...
  return (
    <div className={styles["panel"]}>
      ...
      <div className={styles["add-button"]}>
        <CustomButton displayValue={"Add an Item"} displayIcon={<AddCircleIcon/>} onClick={() => setAddModalOpen(true)}/>
      </div>
      <div className={styles["edit-button"]}>
      <CustomButton displayValue={"Edit an Item"} displayIcon={<EditNoteIcon/>} onClick={() => setEditModalOpen(true)}/>

        </div>
        <div className={styles["delete-button"]}>
        <CustomButton displayValue={"Delete an Item"} displayIcon={<DeleteIcon/>} onClick={() => setDeleteModalOpen(true)}/>
